                    ...
                    <div class="related-news clearfix">
                        ...
                        <ul class="clearfix">
                            <li><a href=""><img class="img-responsive"
                                                src="<?php echo get_template_directory_uri(); ?>/assets/images/sofa-da-that-phoi-go-den-tu-thuong-hieu-noi-that-erado.png"
                                                alt=""></a><a class="summary-content" href="">Sức hút từ bộ sưu tập sofa
                                    da thật phối gỗ của thương hiệu nội thất </a></li>
                            <li><a href=""><img class="img-responsive"
                                                src="<?php echo get_template_directory_uri(); ?>/assets/images/ghe-sofa-thong-minh-voi-ngan-keo-ra-thanh-giuong.png"
                                                alt=""></a><a class="summary-content" href="">Ghế sofa thông minh với
                                    ngăn kéo ra thành giường</a></li>
                            <li><a href=""><img class="img-responsive"
                                                src="<?php echo get_template_directory_uri(); ?>/assets/images/me-man-voi-nhung-mau-ghe-sofa-cho-chung-cu-nho.png"
                                                alt=""></a><a class="summary-content" href="">Mê mẩn với những mẫu ghế
                                    sofa cho chung cư nhỏ</a></li>
                        </ul>
                    </div>
                ...
                <div class="col-md-7 promotion-products">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-ssmm-6 col-ssm-6 feature-product-wrapp">
                            ...
                            <a class="wrapper-link" href=""><img class="img-responsive"
                                                                 src="<?php echo get_template_directory_uri(); ?>/assets/images/sofa-phong-khach-ma-242-2261.jpg"
                                                                 alt=""><span
                                        class="feature-price-sale">21.900</span></a>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-ssmm-6 col-ssm-6 feature-product-wrapp">
                    ...
                    <a class="wrapper-link" href=""><img class="img-responsive"
                                                         src="<?php echo get_template_directory_uri(); ?>/assets/images/ban-an-ma-t1608-6935.jpg"
                                                         alt=""><span class="feature-price-sale">21.900</span></a>
                    <div class="feature-price-real">25,000,000 <span class="currency">đ</span></div>
            ...
            <div class="row videos-content">
                <div class="col-md-6">
                    <div class="videos-main-product">
                        <a class="img-wrapper" href=""><img class="img-responsive"
                                                            src="<?php echo get_template_directory_uri(); ?>/assets/images/ban-an-8-ghe-ma-t1723_8270.jpg"
                                                            alt=""></a>
        ...
        <div class="container">
            ...
            <div class="store-services-content row">
                <div class="col-md-3 phy-facilities">
                    ...
                    <p class="item-desc">
                        Showroom rộng lớn, thiết kế hiện đại sang trọng theo tiêu chuẩn 3S, phục vụ tốt nhất cho khách
                        hàng
                    </p>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="news-content-wr">
                        <a href=""><img class="img-responsive"
                                        src="<?php echo get_template_directory_uri(); ?>/assets/images/ban-giao-noi-that-cho-anh-long-o-flc-thanh-hoa.jpg"
                                        alt=""></a>
                        <p class="news-summary">Thương hiệu nội thất ERADO vô cùng vui mừng khi anh Long ở FLC Thanh Hóa
                            đã quyết định chọn nội thất cho căn nhà của </p>
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="news-content-wr">
                        <a href=""><img class="img-responsive"
                                        src="<?php echo get_template_directory_uri(); ?>/assets/images/nen-mua-ban-ghe-an-loai-nao.jpg"
                                        alt=""></a>
                        <p class="news-summary">Ghế ăn hiện đại với khung thép cứng và được bọc da hoàn toàn vô cùng
                            hiện đại và sang trọng cũng như tốt cho sức khỏe của gia đình. </p>
                    </div>
                    <div class="other-news">
                        <h5 class="other-news-title">Các tin khác</h5>
                        <ul>
                ...
                <div class="col-md-4">
                    ...
                    <div class="news-content-wr">
                        <a href=""><img class="img-responsive"
                                        src="<?php echo get_template_directory_uri(); ?>/assets/images/sofa-da-that-phoi-go-den-tu-thuong-hieu-noi-that-erado.png"
                                        alt=""></a>
                        <p class="news-summary">Thương hiệu nội thất ERADO giới thiệu đến quý khách hàng bộ sưu tập sofa
    ...
    <div class="section9 newsletter">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7">
                    <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/assets/images/169.jpg"
