...
<div class="mobile-quick-menu">
    <div class="container">
        <div class="row">
            ...
            <div class="col-ssmm-4 col-ssm-2">
                <a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/hang-trang-tri-10.png"
                                alt=""><span class="title-quickmn">Hàng trang trí</span></a>
            </div>
            <div class="col-ssmm-4 col-ssm-2">
                <a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/giay-dan-tuong-11.png"
                                alt=""><span class="title-quickmn">Giấy dán tường</span></a>
            </div>
            <div class="col-ssmm-4 col-ssm-2">
                <a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/thiet-ke-noi-that-12.png"
        ...
        <div class="container">
            <div class="col-ssmm-12 col-ssm-12 col-md-3 col-left-pr">
                ...
                <div class="online-support">
                    ...
                    <ul>
                        <li class="light">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/dich-vu-bao-hanh.png"
                                 alt="">
                ...
                <div class="customer-purchased clearfix">
                    ...
                    <div class="customers-news">
                        ...
                        <a class="view-more"
                           href="https://www.facebook.com/pg/zsofa.vn1/photos/?tab=album&album_id=818838611627129">Bộ
                            sưu tập Sofa đã bàn giao tại zsofa.vn</a>
                    </div>
                    ...
                    if ($categories) {
                        ...
                        if ($my_query->have_posts()):
                            ...
                            while ($my_query->have_posts()):$my_query->the_post();
                                ?>
                                <li class="clearfix"><a
                                            href="<?php the_permalink() ?>"><?php the_post_thumbnail(); ?></a><a
            ...
            <div class="col-md-4">
                ...
                <div class="news-content-wr">
                    <a href=""><img class="img-responsive"
                                    ...
                                    alt=""></a>
                    <p class="news-summary">Thương hiệu nội thất ERADO vô cùng vui mừng khi anh Long ở FLC Thanh Hóa đã
                        quyết định chọn nội thất cho căn nhà của </p>
                </div>
            ...
            <div class="col-md-4">
                ...
                <div class="news-content-wr">
                    <a href=""><img class="img-responsive"
                                    ...
                                    alt=""></a>
                    <p class="news-summary">Ghế ăn hiện đại với khung thép cứng và được bọc da hoàn toàn vô cùng hiện
                        đại và sang trọng cũng như tốt cho sức khỏe của gia đình. </p>
                </div>
                <div class="other-news">
                    <h5 class="other-news-title">Các tin khác</h5>
                    <ul>
            ...
            <div class="col-md-4">
                ...
                <div class="news-content-wr">
                    <a href=""><img class="img-responsive"
                                    ...
                                    alt=""></a>
                    <p class="news-summary">Thương hiệu nội thất ERADO giới thiệu đến quý khách hàng bộ sưu tập sofa da
                        thật phối gỗ hiện đại đang được rất nhiều khách hàng </p>
                </div>
                <div class="other-news">
                    <h5 class="other-news-title">Các tin khác</h5>
                    <ul>
...
<div class="fb-page" data-href="https://www.facebook.com/zsofavn2/" data-tabs="timeline" data-small-header="false"
     data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
    <blockquote cite="https://www.facebook.com/zsofavn2/" class="fb-xfbml-parse-ignore"><a
                href="https://www.facebook.com/zsofavn2/">zsofa.vn - Gò Vấp - Hệ thống bán sỉ và lẻ ghế sofa.</a>
    </blockquote>
</div>
