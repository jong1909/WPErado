            ...
            <div class="container">
                ...
                <div class="col-ssmm-12 col-ssm-12 col-md-9 col-right-pr">
                    <div class="bread-crumb-cat clearfix">
                        <ul>
                            <li><a href="/">Home</a></li>
                            <li><a href="">Trang không tồn tại</a></li>
                        </ul>
                    </div>
                    <h3 class="news-main-title"><?php esc_html_e( 'Oops! Trang bạn đang xem không tồn tại.', 'zsofa' ); ?></h3>
                    <div class="news-content-detail-wrapper">
                        <div class="news-main-content">
                            <p><?php esc_html_e( 'Trang bạn đang xem không tồn tại. Hãy thử tìm kiếm hoặc quay trở lại trang chủ.', 'zsofa' ); ?></p>
                            <?php
