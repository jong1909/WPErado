...
register_sidebar(array(
    'name' => 'Block Filter Products Price',
    'id' => 'zsofawidget-filter-product-price',
    'description' => 'Khu vực sidebar hiển thị lọc giá sản phẩm',
    'before_widget' => '<aside id="%1$s" class="widget %2$s">',
    'after_widget' => '</aside>',
    'before_title' => '<h1 class="widget-title">',
    'after_title' => '</h1>'
...
register_sidebar(array(
    'name' => 'Block Banner Support',
    'id' => 'zsofawidget-banner-support-online',
    'description' => 'Khu vực sidebar hiển thị banner hỗ trợ online',
    'before_widget' => '<aside id="%1$s" class="widget %2$s">',
    'after_widget' => '</aside>',
    'before_title' => '<h1 class="widget-title">',
    'after_title' => '</h1>'
