...
<p>
	...
	<label for="<?php echo esc_attr( $id_j_icon ); ?>"><?php _e('fa-* | title', 'yatheme')?>
	...
	<?php }?>
	<label for="<?php echo esc_attr( $id_j_link ); ?>"><?php _e('Link ', 'yatheme')?> </label>
...
<?php
		...
		?>
<p>
	<strong><?php _e( 'Add a new social network', 'yatheme' ) ?></strong><br> <label
