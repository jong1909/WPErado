	...
	function ya_product_thumbnail( $size = 'shop_catalog', $placeholder_width = 0, $placeholder_height = 0  ) {
		...
		if ( has_post_thumbnail() ){
			if( $attachment_image ){
				...
				$html .= '<div class="product-thumb-hover 2">';
...
add_action('woocommerce_after_shop_loop', 'ya_woocommerce_catalog_ordering', 16);
...
function ya_woocommerce_catalog_ordering() {
	...
	$html .= '<li>';
	$html .= '<span class="current-li"><a>'.__('16', 'yatheme').'</a></span>';
	$html .= '<ul>';
