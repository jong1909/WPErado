...
function ya_sticky_menu(){
	$sticky_menu = ya_options()->getCpanelValue( 'menu_style' );
	$output = '';
	if( $sticky_menu == 'sticky_menu' ){
		...
		$output .= '$("#primary-menu").css({ "position": "fixed", "top":0, "left":0, "right" : 0, "z-index": 9999 });';
		$output .= '} else {';
		$output .= '$("#primary-menu").css({ "position": "static" });';
		$output .= '}';
		$output .= '};';
