...
function Ya_Options_Setup(){
	...
	$options[] = array(
			...
			'desc' => __('<p class="description">zSOFA.vn</p>', 'yatheme'),
	...
	$options[] = array(
			...
			'fields' => array(
					array(
							...
							'sub_desc' => __( 'Select one of 5 predefined schemes', 'yatheme' ),
							'desc' => '',
							'options' => array(
		...
		'title' => __('Header', 'yatheme'),
			...
			'fields' => array(
				 array(
							...
							'sub_desc' => __( 'Select Header style', 'yatheme' ),
							'options' => array(
									'style1'  => 'Style 1',
									'style2'  => 'Style 2',
									'style3'  => 'Style 3',
				 ...
				 array(
							...
							'sub_desc' => __( 'Fill here your phone number to be displayed in header.', 'yatheme' ),
							'std' => ''
						),
				 array(
							'id' => 'search',
	...
	$options[] = array(
			...
			'fields' => array(
					...
					/* array(
							...
							'sub_desc' => __( 'Check to active effect scroll in homepage', 'yatheme' ),
							'desc' => '',
							'std' => '1'// 1 = on | 0 = off
							), */					
					array(
							...
							'type' => 'text',
							'sub_desc' => __( 'Enter Google Analytics code', 'yatheme' ),
	...
	$options_args['page_title'] = wp_get_theme()->get('Name') . ' ' . __( 'Theme Options', 'yatheme' );
