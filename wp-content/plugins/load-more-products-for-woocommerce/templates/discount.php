<?php
$start_time        = 1498413376;
$end_time          = 1514764801;
$promo_price       = '$10.00';
$discount          = '60%';
$save_amount       = '$15.00';
$promo_plugin_name = 'WooCommerce Load More Products';
$promo_plugin_link = 'http://berocket.com/product/woocommerce-load-more-products';

if (0 and time() > $start_time && time() < $end_time ) { ?>
    <div class="discount-block-check"></div>
    <div class="wrap discount-block">
        <img src="<?php echo plugin_dir_url( __FILE__ ) ?>../images/60p_sale.jpg" />
        <div>
            <?php
        ...
        <a class="buy_button" href="%link%" target="_blank">Read More</a>';
