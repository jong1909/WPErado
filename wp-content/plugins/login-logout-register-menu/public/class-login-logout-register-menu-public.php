...
class Login_Logout_Register_Menu_Public {
	...
	function llrm_shortcode_login( $atts, $content = null ) {
		...
		if ( $content == '' ) {
			$content = __( 'Đăng nhập', 'login-logout-register-menu' );
		}
	...
	function llrm_shortcode_loginlogout( $atts, $content = null ) {
		...
		if ( $content && strstr( $content, '|' ) != '' ) { // the "|" char is used to split titles
			...
			$content = is_user_logged_in() ? "<span class='user_logged_in'>".__( 'Đăng xuất', 'login-logout-register-menu' )."</span>" : __( 'Đăng nhập', 'login-logout-register-menu' );
		}
	...
	function llrm_shortcode_register( $atts, $content = null ) {
		...
		if ( $content == '' ) {
			$content = __( 'Đăng ký tài khoản', 'login-logout-register-menu' );
		}
