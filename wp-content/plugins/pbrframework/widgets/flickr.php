...
class PBR_Flickr_Widget extends PBR_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'pbr_flickr_widget',
            // Widget name will appear in UI
            __('PBR Flickr', 'pbrframework'),
            // Widget description
            array( 'description' => __( 'The most recent photos from flickr.', 'pbrframework' ), )
        );
...
register_widget( 'PBR_Flickr_Widget' );