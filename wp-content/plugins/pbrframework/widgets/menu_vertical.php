...
class PBR_Menu_Vertical extends PBR_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'pbr_menu_vertical',
            // Widget name will appear in UI
            __('PBR Menu Vertical Widget', 'pbrframework'),
            // Widget description
            array( 'description' => __( 'Show Menu Vertical', 'pbrframework' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            <select name="<?php echo esc_attr($this->get_field_name( 'menu' )); ?>" id="<?php echo esc_attr($this->get_field_id( 'menu' )); ?>">
                <option value="" <?php selected( $pbr_menu, $menu->term_id ); ?>>---Select Menu---</option>
...
register_widget( 'PBR_Menu_Vertical' );