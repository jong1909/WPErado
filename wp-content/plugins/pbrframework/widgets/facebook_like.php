...
class PBR_Facebook_Like_Box extends PBR_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'pbr_facebook_like',
            // Widget name will appear in UI
            __('PBR Facebook Like Box', 'pbrframework'),
            // Widget description
            array( 'description' => __( 'Adds support for Facebook Like Box. ', 'pbrframework' ), )
        );
...
register_widget( 'PBR_Facebook_Like_Box' );