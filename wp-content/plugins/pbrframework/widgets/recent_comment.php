...
class PBR_Recent_Comment extends PBR_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'pbr_recent_comment',
            // Widget name will appear in UI
            __('PBR Recent Comments Widget', 'pbrframework'),
            // Widget description
            array( 'description' => __( 'Show list of recent comments', 'pbrframework' ), )
        );
...
// Widget Backend
    public function form( $instance ) {
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = __( 'Latest Post', 'pbrframework' );
        }
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_comment' )); ?>"><?php _e( 'Num Comments:', 'pbrframework' ); ?></label>
...
register_widget( 'PBR_Recent_Comment' );