...
class PBR_Recent_Post extends PBR_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'pbr_recent_post',
            // Widget name will appear in UI
            __('PBR Recent Posts Widget', 'pbrframework'),
            // Widget description
            array( 'description' => __( 'Show list of recent post', 'pbrframework' ), )
        );
...
// Widget Backend
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_post' )); ?>"><?php _e( 'Num Posts:', 'pbrframework' ); ?></label>
...
register_widget( 'PBR_Recent_Post' );