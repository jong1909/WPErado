...
if(class_exists('PostRatings')){
    ...
    class PBR_Top_Rate_Widget extends PBR_Widget {
        public function __construct() {
            parent::__construct(
                // Base ID of your widget
                'pbr_top_rate_widget',
                // Widget name will appear in UI
                __('PBR Top Rate Widget', 'pbrframework'),
                // Widget description
                array( 'description' => __( 'The highest rated posts on your site', 'pbrframework' ), )
            );
    ...
    register_widget( 'PBR_Top_Rate_Widget' );
}