...
class PBR_Posts extends PBR_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'pbr_posts',
            // Widget name will appear in UI
            __('PBR Posts Widget', 'pbrframework'),
            // Widget description
            array( 'description' => __( '', 'pbrframework' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'ids' )); ?>"><?php echo __( 'Posts:', 'pbrframework' ); ?></label>
            <br>
