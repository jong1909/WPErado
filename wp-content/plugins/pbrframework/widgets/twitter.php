...
class PBR_Tweets_Widget extends PBR_Widget{
    ...
    public function __construct() {
         parent::__construct(
            ...
            __('PBR Latest Twitter', 'pbrframework'),
            // Widget description
            array( 'description' => __( 'Latest Twitter widget.', 'pbrframework' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $defaults = array( 'title' => __('Latest tweets.', 'pbrframework'),
                            'user' => __('Leotheme', 'pbrframework'),
                ...
                $values = array(
                    1 => __('Yes', 'pbrframework'),
                    0 => __('No', 'pbrframework'),
                );              
        $instance = wp_parse_args( (array) $instance, $defaults ); ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php _e('Title:', 'pbrframework'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'user' )); ?>"><?php _e('Twitter Username:', 'pbrframework'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'limit' )); ?>"><?php _e('Limit:', 'pbrframework'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'twitter_id' )); ?>"><?php _e('Twitter Id:', 'pbrframework'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'border_color' )); ?>"><?php _e('Border Color:', 'pbrframework'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'link_color' )); ?>"><?php _e('Link Color:', 'pbrframework'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'text_color' )); ?>"><?php _e('Text Color:', 'pbrframework'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'name_color' )); ?>"><?php _e('Name Color:', 'pbrframework'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'mail_color' )); ?>"><?php _e('Mail Color:', 'pbrframework'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'transparent' )); ?>"><?php _e('Show background', 'pbrframework'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_replies' )); ?>"><?php _e('Show Replies', 'pbrframework'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_header' )); ?>"><?php _e('Show Header', 'pbrframework'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_footer' )); ?>"><?php _e('Show Footer', 'pbrframework'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_border' )); ?>"><?php _e('Show Border', 'pbrframework'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_scrollbar' )); ?>"><?php _e('Show Scrollbar', 'pbrframework'); ?></label>
            <br>
...
register_widget( 'PBR_Tweets_Widget' );
