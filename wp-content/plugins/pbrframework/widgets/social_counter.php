...
class bk_social_counter extends WP_Widget {
					...
					<li class="twitter clear-fix">
                        <a target="_blank" href="http://twitter.com/<?php echo esc_attr( $bk_twitter_id ); ?>">
    						...
    						<div class="left">
    							...
    							<div class="text"><?php _e('Followers', 'pbrframework');?></div>
    						</div>
                        </a>
					</li> <!-- /twitter -->
				<?php } ?>
					...
					<li class="facebook clear-fix">
                        <a target="_blank" href="<?php echo get_option('bk_facebook_link'); ?>">
    						...
    						<div class="left">				
    							...
    							<div class="text"><?php _e('Likes', 'pbrframework');?></div>				
    						</div>
                        </a>
					</li><!-- /facebook -->
				<?php } ?>
					...
					<li class="youtube clear-fix">
                        <a target="_blank" href="http://www.youtube.com/user/<?php echo esc_attr( $bk_youtube_username ) ;?>">
    						...
    						<div class="left">
    							...
    							<div class="text"><?php _e('Subscribe', 'pbrframework'); ?></div>		
    						</div>
                        </a>				
					</li>
				<?php } ?>
                ...
                <?php if (isset($bk_rss_url)){ ?>
					<li class="rss clear-fix">
                        <a target="_blank" href="<?php echo esc_url( $bk_rss_url ); ?>">
    						...
    						<div class="left">
    							<div class="subscribe"><h4><?php _e('Subscribe', 'pbrframework'); ?></h4></div>
    							<div class="text"><?php _e('RSS Feeds', 'pbrframework'); ?></div>		
    						</div>	
                        </a>			
					</li>
				<?php } ?>
	...
	function form( $instance ) {
		...
		<!-- Title: Text Input -->     
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><strong><?php _e('Title:', 'pbrframework');?></strong></label>
            <input type="text" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" value="<?php echo esc_attr( $instance['title'] )); ?>" class="widefat" />
		</p>
                
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'bk_facebook_username' )); ?>"><strong><?php _e('Facebook Username:', 'pbrframework');?></strong></label>
        ...
        <p>
			<label for="<?php echo esc_attr($this->get_field_id( 'bk_dribbble_username' ); ?>"><strong><?php _e('Dribbble Username', 'pbrframework');?></strong></label>
        ...
        <p>
			<label for="<?php echo esc_attr($this->get_field_id( 'bk_youtube_username' ); ?>"><strong><?php _e('Youtube username', 'pbrframework');?></strong></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'bk_rss_url' )); ?>"><strong><?php _e('RSS URL', 'pbrframework');?></strong></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'bk_twitter_id' )); ?>"><strong><?php _e('Twitter Name', 'pbrframework');?></strong></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'bk_consumer_key' )); ?>"><strong><?php _e('Consumer key', 'pbrframework') ?></strong></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'bk_consumer_secret') ); ?>"><strong><?php _e('Consumer secret', 'pbrframework') ?></strong></label>
