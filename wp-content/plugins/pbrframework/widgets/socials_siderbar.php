...
class PBR_Socials_Siderbar_Widget extends PBR_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'pbr_socials_siderbar_widget',
            // Widget name will appear in UI
            __('PBR Socials Siderbar', 'pbrframework'),
            // Widget description
            array( 'description' => __( 'Share Socials Siderbar for website.', 'pbrframework' ), )
        );
...
// Widget Backend
    ...
    ?>
    <div class="pbr_socials_siderbar">
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'list_service' )); ?>"><?php echo __( 'Share services social:', 'pbrframework' ); ?></label>
            <br>
...
register_widget( 'PBR_Socials_Siderbar_Widget' );