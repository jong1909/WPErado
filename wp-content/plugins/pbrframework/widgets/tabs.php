...
class PBR_Tabs_Widget extends PBR_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'pbr_tabs_widget',
            // Widget name will appear in UI
            __('PBR Tabs Widget', 'pbrframework'),
            // Widget description
            array( 'description' => __( 'Popular posts, recent post and comments.', 'pbrframework' ), )
        );
...
register_widget( 'PBR_Tabs_Widget' );