...
if(class_exists('Featured_Post_Widget')){
    ...
    class PBR_Featured_Post_Widget extends PBR_Widget {
        public function __construct() {
            parent::__construct(
                // Base ID of your widget
                'pbr_featured_post_widget',
                // Widget name will appear in UI
                __('PBR Featured Post Widget', 'pbrframework')
            );
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('num')); ?>"><?php __('Limit:', 'pbrframework'); ?></label>
                <br>
    ...
    register_widget( 'PBR_Featured_Post_Widget' );
}