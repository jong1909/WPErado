...
class PBR_Sliders_Widget extends PBR_Widget{
    ...
    public function __construct() {
        parent::__construct(
            ...
            __('PBR Sliders Widget', 'pbrframework'),
            // Widget description
            array( 'description' => __( 'Adds support Slider. ', 'pbrframework' ), )
        );
    ...
    public function initScripts(){
        $url = PBR_THEME_URI.'/framework/widgets/sliders/assets/';
...
register_widget( 'PBR_Sliders_Widget' );
