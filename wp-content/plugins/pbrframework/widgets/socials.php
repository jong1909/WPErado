...
class PBR_Socials_Widget extends PBR_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'pbr_socials_widget',
            // Widget name will appear in UI
            __('PBR Socials', 'pbrframework'),
            // Widget description
            array( 'description' => __( 'Socials for website.', 'pbrframework' ), )
        );
...
register_widget( 'PBR_Socials_Widget' );