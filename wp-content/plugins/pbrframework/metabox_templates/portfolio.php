...
<div id="pbr-post" class="pbr-metabox">
    ...
    <div class="pbr-meta-content active" id="pbr-config">
        ...
        <!--show title config -->
            ...
            <?php 
                $_enabal_config = array('id'=>'config_layout','title'=> __('Enable config layout',"pbrframework") );
        ...
        <?php
            $layout = array('id' => 'page_layout', 'title' => __('Select page layout',"pbrframework") );
    ...
    <?php 
        $right_sidebars = array('id'=> 'right_sidebar','title'=> __('Right Sidebar', "pbrframework"),'data'=>$wp_registered_sidebars,'default'=>'sidebar-right');
    ...
    <!--Pofolio format-->
    <div class="pbr-meta-content" id="pbr-format">
        <!--Select portfolio Format-->
        <p class="pbr_section" data-group="portfolio_format" data-id="default:slideshow:video:gallery:infomation:fullscreen">
            <?php
            $data_format = array(
                array('id'=>'default', 'name' => __('Default', "pbrframework") ),
                array('id'=>'slideshow', 'name' => __('Slideshow', "pbrframework" ) ),
                array('id'=>'video', 'name' => __('Video', "pbrframework") ),
                array('id'=>'gallery', 'name' => __('Gallery', "pbrframework") ),
                array('id'=>'infomation', 'name'=> __('Infomation', "pbrframework") ),
                array('id'=>'fullscreen', 'name'=>__('Fullscreen', "pbrframework"))
            );
                $format = array(
                    'id'=> 'portfolio_format',
                    'title'=> __('Portfolio format', "pbrframework"),
                    'data'=>$data_format,
                    'default'=>'default'
                );
        ...
        <!-- Gallery-->
        <p class="pbr_section portfolio_format slideshow gallery fullscreen">
        ...
        <p class="pbr_section portfolio_format video">
            <?php
                $video_link = array(
                    'id'    => 'portfolio_video',
                    'title' => 'Video link',
            ...
            ?>
            <div class="pbr_embed_view portfolio_format video">
        ...
        <!-- Infomation -->
        <p class="pbr_section portfolio_format infomation">
            <?php
                $author = array(
                    'id'    => 'author',
                    'title' => 'Author',
