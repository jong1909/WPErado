...
if(!class_exists('PBR_Megamenu_Config')){
    class PBR_Megamenu_Config extends Walker_Nav_Menu  {
        /**
        ...
        public function start_el(&$output, $item, $depth=0, $args=array(),$current_object_id=0) {
            ...
            if ( ! empty( $item->_invalid ) ) {
                ...
                $title = sprintf( __( '%s (Invalid)',"pbrframework" ), $item->title );
            } elseif ( isset( $item->post_status ) && 'draft' == $item->post_status ) {
                $classes[] = 'pending';
                /* translators: %s: title of menu item in draft status */
                $title = sprintf( __('%s (Pending)',"pbrframework"), $item->title );
            }
                ...
                <dl class="menu-item-bar">
                    <dt class="menu-item-handle">
                        ...
                        <span class="item-controls">
                            ...
                            ?>"><?php _e( 'Edit Menu Item',"pbrframework" ); ?></a>
                        </span>
                    </dt>
                </dl>
                ...
                <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
                    ...
                    <p class="description description-thin">
                        <label for="edit-menu-item-title-<?php echo $item_id; ?>">
                            <?php _e( 'Navigation Label',"pbrframework" ); ?><br />
                            <input type="text" id="edit-menu-item-title-<?php echo $item_id; ?>" class="widefat edit-menu-item-title" name="menu-item-title[<?php echo $item_id; ?>]" value="<?php echo esc_attr( $item->title ); ?>" />
                        </label>
                    </p>
                    <p class="description description-thin">
                        <label for="edit-menu-item-attr-title-<?php echo $item_id; ?>">
                            <?php _e( 'Title Attribute',"pbrframework" ); ?><br />
                    ...
                    <p class="field-link-target description">
                        <label for="edit-menu-item-target-<?php echo $item_id; ?>">
                            ...
                            <?php _e( 'Open link in a new window/tab',"pbrframework" ); ?>
                        </label>
                    </p>
                    <p class="field-css-classes description description-thin">
                        <label for="edit-menu-item-classes-<?php echo $item_id; ?>">
                            <?php _e( 'CSS Classes (optional)',"pbrframework" ); ?><br />
                            <input type="text" id="edit-menu-item-classes-<?php echo $item_id; ?>" class="widefat code edit-menu-item-classes" name="menu-item-classes[<?php echo $item_id; ?>]" value="<?php echo esc_attr( implode(' ', $item->classes ) ); ?>" />
                        </label>
                    </p>
                    <p class="field-xfn description description-thin">
                        <label for="edit-menu-item-xfn-<?php echo $item_id; ?>">
                            <?php _e( 'Link Relationship (XFN)',"pbrframework" ); ?><br />
                            <input type="text" id="edit-menu-item-xfn-<?php echo $item_id; ?>" class="widefat code edit-menu-item-xfn" name="menu-item-xfn[<?php echo $item_id; ?>]" value="<?php echo esc_attr( $item->xfn ); ?>" />
                        </label>
                    </p>
                    <p class="field-description description description-wide">
                        <label for="edit-menu-item-description-<?php echo $item_id; ?>">
                            <?php _e( 'Description',"pbrframework" ); ?><br />
                            <textarea id="edit-menu-item-description-<?php echo $item_id; ?>" class="widefat edit-menu-item-description" rows="3" cols="20" name="menu-item-description[<?php echo $item_id; ?>]"><?php echo esc_html( $item->description ); // textarea_escaped ?></textarea>
                            <span class="description"><?php _e('The description will be displayed in the menu if the current theme supports it.',"pbrframework"); ?></span>
                        </label>
                    </p>
                    <?php
                    /*
                    ...
                    <div class="menu-item-actions description-wide submitbox">
                        <?php if( 'custom' != $item->type && $original_title !== false ) : ?>
                            <p class="link-to-original">
                                <?php printf( __('Original: %s',"pbrframework"), '<a href="' . esc_attr( $item->url ) . '">' . esc_html( $original_title ) . '</a>' ); ?>
                            </p>
                        <?php endif; ?>
                        ...
                        ); ?>"><?php _e('Remove',"pbrframework"); ?></a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-<?php echo $item_id; ?>" href="<?php echo esc_url( add_query_arg( array('edit-menu-item' => $item_id, 'cancel' => time()), remove_query_arg( $removed_args, admin_url( 'nav-menus.php' ) ) ) );
                            ?>#menu-item-settings-<?php echo $item_id; ?>"><?php _e('Cancel',"pbrframework"); ?></a>
                    </div>
    ...
    ?>
        <p class="field-addclass description description-wide">
            <label for="edit-menu-item-text_customize-<?php echo esc_attr($item_id); ?>">
                <?php  echo __( 'Label', "pbrframework" ); ?><br />
                <select name="menu-item-text_customize[<?php echo esc_attr($item_id); ?>]">
                  <option value="" <?php selected( esc_attr($item->text_customize), '' ); ?>><?php _e('None', "pbrframework"); ?></option>
                  <option value="text_new" <?php selected( esc_attr($item->text_customize), 'text_new' ); ?>><?php _e('New', "pbrframework"); ?></option>
                  <option value="text_hot" <?php selected( esc_attr($item->text_customize), 'text_hot' ); ?>><?php _e('Hot', "pbrframework"); ?></option>
                  <option value="text_featured" <?php selected( esc_attr($item->text_customize), 'text_featured' ); ?>><?php _e('Featured', "pbrframework"); ?></option>
                </select>
            </label>
        </p>
    <?php
...
?>
      <p class="field-addclass description description-wide">
          <label for="edit-menu-item-megamenu_profile-<?php echo esc_attr($item_id); ?>"> 
              <?php _e(  'Megamenu Profile' ); ?> <br>
               <select name="menu-item-megamenu_profile[<?php echo esc_attr($item_id); ?>]">
                <option value=""><?php _e( 'Disable', "pbrframework" ); ?></option>
          ...
          <a href="<?php echo  esc_url( admin_url( 'edit.php?post_type=megamenu_profile') ); ?>" target="_blank" title="<?php _e( 'Profiles Management', "pbrframework" ); ?>"><?php _e( 'Profiles Management', "pbrframework" ); ?></a>
          <div><?php _e( 'If enabled megamenu, its submenu will be disabled', "pbrframework" ); ?></div>
      </p>

       <p class="field-width description description-wide">   
        <label  for="edit-menu-item-width-<?php echo esc_attr($item_id); ?>"><?php _e( 'Width:', "pbrframework" ); ?> <br>
      ...
      <?php 
        $aligns = array(
              'left' => __('Left', "pbrframework"),
              'right' => __('Right', "pbrframework"),
              'fullwidth' => __('Fullwidth', "pbrframework")
          ); 
      ?> 
      <p class="field-alignment description description-wide">   
          <label  for="edit-menu-item-alignment-<?php echo esc_attr($item_id); ?>"><?php _e( 'Alignment:', "pbrframework" ); ?> <br>
...
if(!function_exists('pbr_custom_nav_edit_walker')){
    ...
    function pbr_custom_nav_edit_walker($walker,$menu_id) {
        return 'PBR_Megamenu_Config';
    }
}

function pbr_themer_megamenu_megamenu(){ 
    wp_enqueue_style( 'megamenu_css', PBR_PLUGIN_FRAMEWORK_URL.'assets/css/megamenu.css');
    wp_enqueue_script('megamenu_js', PBR_PLUGIN_FRAMEWORK_URL.'assets/js/megamenu.js');   
}
add_action( 'admin_init', 'pbr_themer_megamenu_megamenu' );

function pbr_create_megamenu_profiles(){   
  $labels = array(
    'name' => __( 'Opal Megamenu', "pbrframework" ),
    'singular_name' => __( 'Megamenu', "pbrframework" ),
    'add_new' => __( 'Add Profile', "pbrframework" ),
    'add_new_item' => __( 'Add Profile', "pbrframework" ),
    'edit_item' => __( 'Edit Profile', "pbrframework" ),
    'new_item' => __( 'New Profile', "pbrframework" ),
    'view_item' => __( 'View Profile', "pbrframework" ),
    'search_items' => __( 'Search Profile', "pbrframework" ),
    'not_found' => __( 'No Profiles found', "pbrframework" ),
    'not_found_in_trash' => __( 'No Profiles found in Trash', "pbrframework" ),
    'parent_item_colon' => __( 'Parent Profile:', "pbrframework" ),
    'menu_name' => __( 'Opal Megamenu', "pbrframework" ),
  );
  ...
  if($options = get_option('wpb_js_content_types')){
    ...
    foreach ($options as $key => $value) {
      if($value=='megamenu_profile') $check=false;
    }
    if($check)
      $options[] = 'megamenu_profiles';
      update_option( 'wpb_js_content_types',$options );
  }else{
    $options = array('page','megamenu_profiles');
  }
...
<div class="wrap wrap-reports">
   <h1><?php _e( 'Megamenu Assignment' , "pbrframework" );?></h1>
  ...
  <form method="post" action="<?php echo  esc_url( admin_url( 'edit.php?post_type=megamenu_profile&page=megamenu-setting&group='.$group) ); ?>">
         ...
         <div class="manage-menus">
                <div class="pull-left">
                  ...
                  <label class="selected-menu" for="menu"><?php echo __('Menu Group', "pbrframework"); ?>:</label>
                ...
                <div class="pull-left">
                   ...
                   <?php if( $group ) { ?>
                   <p class="submit"> <a href="<?php echo  esc_url( admin_url( 'edit.php?post_type=megamenu_profile&page=megamenu-setting&reset=1&group='.$group) ); ?>"><?php _e( 'Reset', "pbrframework" );?></a></p>
                   <?php } ?>
                </div>  
          </div>
                          ...
                          <ul class="inline-menu">
                           ...
                           <li class="menu-item">
                            ...
                            <dl class="menu-item-wrap"><dt class="menu-item-inner ">
                                <em><?php _e( 'Close' , "pbrframework" ); ?></em>
                              <div>
                              ...
                              <div>   
                                <label><?php _e( 'Width:', "pbrframework" ); ?> </label>
                              ...
                              ?> 
                              <div>   
                                <label><?php _e( 'Alignment:', "pbrframework" ); ?> </label>
...
function pbr_add_megamenu_setting() {
   // add_submenu_page(  'edit.php?post_type=megamenu_profile',  __( 'Setting', "pbrframework" ), __( 'Assigment', "pbrframework" ), 'manage_options', 'megamenu-setting',  'pbr_add_megamenu_setting_page'  );
}
